# ngx-bs-daterangepicker
> Pure Angular 2+ Date range picker based bootstrap-daterangepicker.

This plugin is compatible with Angular 2+ , work fine with the latest version of angular. This plugin uses moment.js.
This plugin is a rewrite to angular from [bootstrap daterangepicker](http://www.daterangepicker.com), 
thanks for this [fetrarij/ngx-daterangepicker-material](https://github.com/fetrarij/ngx-daterangepicker-material). So it doesn't depends on jquery or bootstrap(optional).

demo:  http://www.daterangepicker.com

## Installation

 Install the plugin from npm:
 
 `npm install ngx-bs-daterangepicker-material --save` .

 import **NgxBsDaterangepicker** in your module:
...
```html
<input type="text" ngxBsDaterangepicker [(ngModel)]="selected" class="form-control"/>
```
Typescript: 
...
```html
<ngx-bs-daterangepicker (choosedDate)="choosedDate($event)">
</ngx-bs-daterangepicker>
```
...
## [License](https://github.com/r0fest/ngx-bs-daterangepicker/LICENSE)
MIT
